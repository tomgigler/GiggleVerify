...
def update_guild(guild_id, guild_name):
    db_execute_sql("INSERT INTO guilds ( id, name ) values (%s, %s ) ON DUPLICATE KEY UPDATE name = %s",
        False, guild_id=guild_id, guild_name=guild_name, guild_name_2=guild_name)

def update_guild_staff_channel(guild_id, guild_name, staff_channel_id, staff_channel_name):
    db_execute_sql("INSERT INTO guilds ( id, name, staff_channel_id, staff_channel_name ) values (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE name = %s, staff_channel_id = %s, staff_channel_name = %s",
...
def update_guild_message_channel(guild_id, guild_name, message_channel_id, message_channel_name):
    db_execute_sql("INSERT INTO guilds ( id, name, message_channel_id, message_channel_name ) values (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE name = %s, message_channel_id = %s, message_channel_name = %s",
        False, guild_id=guild_id, guild_name=guild_name, message_channel_id=message_channel_id, message_channel_name=message_channel_name,
        guild_name_2=guild_name, message_channel_id_2=message_channel_id, message_channel_name_2=message_channel_name)
...
def get_message_channel_id(guild_id):
    ret = None
    res = db_execute_sql("SELECT message_channel_id FROM guilds WHERE id = %s", True, guil_id=guild_id)
    if len(res):
        ret = res[0][0]
    return ret
